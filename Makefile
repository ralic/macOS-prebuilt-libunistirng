...
CPP = cc -E
CPPFLAGS = -I/usr/local/opt/valgrind/include -I/usr/local/opt/llvm/include -I/usr/local/opt/openblas/include -I/usr/local/opt/qt/include -I/usr/local/opt/readline/include -I/usr/local/opt/gettext/include -I/usr/local/opt/libxml2/include -I/usr/local/opt/libpng/include -I/usr/local/opt/zlib/include -I/usr/local/opt/openssl@1.1/include 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LDFLAGS = -L/usr/local/opt/valgrind/lib -L/usr/local/opt/llvm/lib -Wl,-rpath,/usr/local/opt/llvm/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/qt/lib -L/usr/local/opt/bison/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/gettext/lib -L/usr/local/opt/libxml2/lib -L/usr/local/opt/libpng/lib -L/usr/local/opt/zlib/lib -L/usr/local/opt/openssl@1.1/lib 
LIBICONV = -liconv
LIBINTL = 
