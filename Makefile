...
ACLOCAL = build-aux/fixaclocal ${SHELL} /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7/build-aux/missing aclocal-1.15
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
ARFLAGS = cr
AS = as
AUTOCONF = ${SHELL} /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7/build-aux/missing automake-1.15
AWK = gawk
...
CFLAGS = -Ofast -fomit-frame-pointer -ffast-math -fno-signed-zeros -m64  -mmmx -msse -flto -ffp-contract=fast -funroll-loops 
CPP = cc -E
CPPFLAGS = -I/usr/local/opt/valgrind/include -I/usr/local/opt/llvm/include -I/usr/local/opt/openblas/include -I/usr/local/opt/qt/include -I/usr/local/opt/portable-readline/include -I/usr/local/opt/readline/include -I/usr/local/opt/gettext/include -I/usr/local/opt/libxml2/include -I/usr/local/opt/libpng/include -I/usr/local/opt/zlib/include -I/usr/local/opt/openssl@1.1/include 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
DSYMUTIL = dsymutil
DUMPBIN = 
DVIPS = /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7/build-aux/missing dvips
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
LDFLAGS = -L/usr/local/opt/valgrind/lib -L/usr/local/opt/llvm/lib -Wl,-rpath,/usr/local/opt/llvm/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/qt/lib -L/usr/local/opt/bison/lib -L/usr/local/opt/portable-readline/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/gettext/lib -L/usr/local/opt/libxml2/lib -L/usr/local/opt/libpng/lib -L/usr/local/opt/zlib/lib -L/usr/local/opt/openssl@1.1/lib  -m64 
LIBICONV = -liconv
LIBINTL = 
...
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
WINT_T_SUFFIX = 
YIELD_LIB = 
abs_builddir = /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7
abs_srcdir = /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7
abs_top_builddir = /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7
abs_top_srcdir = /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7
ac_ct_AR = ar
ac_ct_CC = cc
ac_ct_DUMPBIN = 
am__include = include
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  fseterr.o isnanf.o isnanl.o strstr.o wcwidth.o
gl_LTLIBOBJS =  fseterr.lo isnanf.lo isnanl.lo strstr.lo wcwidth.lo
gltests_LIBOBJS =  error.o putenv.o strerror.o strerror-override.o
gltests_LTLIBOBJS =  error.lo putenv.lo strerror.lo strerror-override.lo
...
install_sh = ${SHELL} /Users/dojo/Library/Caches/Homebrew/libunistring-0.9.7/build-aux/install-sh
...
pdfdir = ${docdir}
prefix = /usr/local/Cellar/libunistring/0.9.7
...
lib/unistring/version.h: $(top_builddir)/config.status $(top_srcdir)/lib/unistring/version.in.h
	cd $(top_builddir) && $(SHELL) ./config.status $@
lib/unistring/woe32dll.h: $(top_builddir)/config.status $(top_srcdir)/lib/unistring/woe32dll.in.h
	cd $(top_builddir) && $(SHELL) ./config.status $@
